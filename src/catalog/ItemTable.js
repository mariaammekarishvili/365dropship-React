...
const ItemTable = ({img,title,description,price}) => {
    return(
        <div className={'item-table'}>
            <div className={'item-table__representation'} >
                <div className={'item__cost'}>
                    <Cost text={'RRP'} price={price}/> <Cost text={'COST'} price={Math.round(price - (price * 0.2))}/> <Cost price={Math.round(price * 0.2)} text={'PROFIT'}/>
                </div>
